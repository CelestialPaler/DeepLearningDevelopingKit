...
void Data::NumaricSet::InitWithXOR(void)
{
	...
	target1(0) = 0;
	NumaricSet::Sample tempSample1 = { input1 , input1 };
	...
	target2(0) = 1;
	NumaricSet::Sample tempSample2 = { input2 , input2 };
	...
	target3(0) = 1;
	NumaricSet::Sample tempSample3 = { input3 , input3 };
	...
	target4(0) = 0;
	NumaricSet::Sample tempSample4 = { input4 , input4 };
