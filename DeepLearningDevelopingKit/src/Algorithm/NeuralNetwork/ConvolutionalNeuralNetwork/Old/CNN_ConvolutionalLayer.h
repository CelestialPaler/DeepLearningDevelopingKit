...
namespace Neural
{
	...
	private: // Math Stuff
		...
		// The sum of Cross-correlation matrix of two matrix.
		MathLib::Matrix<ElemType> Hadamard(const MathLib::Matrix<ElemType> & _mat1, const MathLib::Matrix<ElemType> & _mat2);
	...
	public:
		...
		// Delta
		std::vector<MathLib::Matrix<ElemType>> _deltaLastLayer;
